...
function Update:Window(text,logo,keybind)
    ...
    BtnStroke.Color = Color3.fromRGB(0, 255, 76)
    ...
    Ping.Text = " KEYYCUTI HUB | https://discord.com/invite/zuSkMaPBg8 "
...
Page.Image = "http://www.roblox.com/asset/?id=" .. tostring(16149544280)
    ...
    function uitab:AddTab(text,img)
        ...
        NotificationHold.BackgroundColor3 = Color3.new(0, 255, 76)
        ...
        NotificationTitle.TextColor3 = Color3.fromRGB(0, 255, 76)
    ...
    function main:AddButton(text, callback)
        ...
        Button.BackgroundColor3 = Color3.fromRGB(0, 255, 76)
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        UIStroke.Color = Color3.fromRGB(0, 255, 76)
    ...
    function main:AddDropdown(text,option,callback)
        ...
        DropScroll.BackgroundColor3 = Color3.fromRGB(0, 255, 76)
        ...
        DropButton.BackgroundColor3 = Color3.fromRGB(0, 255, 76)
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        SliderFrame.BackgroundColor3 = Color3.fromRGB(0, 255, 76)
        ...
        SliderCount.BackgroundColor3 = Color3.fromRGB(0, 255, 76)
        ...
        SliderStroke.Color = Color3.fromRGB(0, 255, 76)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        Textbox.BackgroundColor3 = Color3.new(0, 255, 76)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        TextboxLabel.Name = "TextboxLabel"
        TextboxLabel.Parent = Textbox
        TextboxLabel.BackgroundColor3 = Color3.fromRGB(0, 255, 76)
        TextboxLabel.BackgroundTransparency = 1.000
        TextboxLabel.Position = UDim2.new(0, 15, 0, 0)
        TextboxLabel.Text = text
        TextboxLabel.Size = UDim2.new(0, 145, 0, 31)
        ...
        RealTextbox.Font = Enum.Font.GothamSemibold
        RealTextbox.Text = ""
        RealTextbox.TextColor3 = Color3.fromRGB(0, 255, 76)
        RealTextbox.TextSize = 11.000
        RealTextbox.TextTransparency = 0
    ...
    function main:AddSeperator(text)
        ...
        Sep1.BackgroundColor3 = Color3.new(0, 255, 76)
        ...
        Sep3.BackgroundColor3 = Color3.new(0, 255, 76)
    ...
    function main:AddLine()
        ...
        Line.Name = "Line"
        Line.Parent = Linee
        Line.BackgroundColor3 = Color3.new(0, 255, 76)
        Line.BorderSizePixel = 0
			...
			if v.Name == "Flower2" or v.Name == "Flower1" then
				if FlowerESP then 
					if not v:FindFirstChild('NameEsp'..Number) then
						...
						name.BackgroundTransparency = 1
						name.TextStrokeTransparency = 0.5
						name.TextColor3 = Color3.fromRGB(0, 255, 76)
...
local Main = Library:AddTab("Chủ Yếu","16352351662")
local M = Library:AddTab("Vật Phẩm","16352351662")
local Ss = Library:AddTab("Thống Kê","16352351662")
local RaceV4 = Library:AddTab("Race V4","16352351662")
local P = Library:AddTab("Chiến Đấu","16352351662")
local R = Library:AddTab("Raid Trái","16352351662")
local T = Library:AddTab("Dịch Chuyển","16352351662")
local S = Library:AddTab("Cửa Hàng","16352351662")
local D = Library:AddTab("Trái Ắc Quỷ","16352351662")
local Misc = Library:AddTab("Linh Tinh","16352351662")
...
Main:AddToggle("Farm Rương (Không Kick)",false,function(value)
 AutoFarmChest = value
...
Main:AddToggle("Dịch Chuyển Farm Rương (Kick)",false,function(vu)
	_G.ChestBypass = vu
end)
...
if _G.ChestBypass then
    ...
    Main:AddButton("Dịch Chuyển Đến Đảo Katakuri",function()
        if BypassTP then
    ...
    Main:AddToggle("Spawn Katakuri",true,function(value)
    ...
    Main:AddToggle("Farm Katakuri V2 Đổi Server", _G.AutodoughkingHop,function(value)
...
M:AddToggle("Tween Mystic Island",_G.AutoMysticIsland,function(value)
        ...
        spawn(function()
            ...
            M:AddButton("Bay Lại NPC Bán Trái Ở Đảo", function()
                TweenNpc()
                end)
...
M:AddToggle("Bánh Răng",_G.TweenMGear,function(value)
_G.TweenMGear = value
