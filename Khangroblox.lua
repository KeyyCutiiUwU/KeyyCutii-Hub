...
local Main = SOMEXHUB:AddTab("Mục Chính","16136469067")
local Sea = SOMEXHUB:AddTab("Mục Event Biển","16136469067")
local M = SOMEXHUB:AddTab("Mục Vật Phẩm","16136469067")
local Ss = SOMEXHUB:AddTab("Mục Chỉ Số","16136469067")
local RaceV4 = SOMEXHUB:AddTab("Mục V4","16136469067")
local P = SOMEXHUB:AddTab("Mục Người chơi","16136469067")
local R = SOMEXHUB:AddTab("Mục Đột Kích","16136469067")
local T = SOMEXHUB:AddTab("Mục Dịch Chuyển","16136469067")
local S = SOMEXHUB:AddTab("Mục Cửa Hàng","16136469067")
local D = SOMEXHUB:AddTab("Mục Trái","16136469067")
