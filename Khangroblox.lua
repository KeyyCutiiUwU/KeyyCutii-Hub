...
Closed.Image = "rbxassetid://16262077562"
    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            function main:AddDropdown(text,table,callback)
                ...
                DropImage.Image = "rbxassetid://16262077562"
...
local Main = SOMEXHUB:AddTab("Chính","16262092006")
local Sea = SOMEXHUB:AddTab("Event Biển","16262092006")
local M = SOMEXHUB:AddTab("Vật Phẩm","16262092006")
local Ss = SOMEXHUB:AddTab("Chỉ Số","16262092006")
local RaceV4 = SOMEXHUB:AddTab("V4","16262092006")
local P = SOMEXHUB:AddTab("Người chơi","16262092006")
local R = SOMEXHUB:AddTab("Đột Kích","16262092006")
local T = SOMEXHUB:AddTab("Dịch Chuyển","16262092006")
local S = SOMEXHUB:AddTab("Cửa Hàng","16262092006")
local D = SOMEXHUB:AddTab("Trái","16262092006")
local Misc = SOMEXHUB:AddTab("Khác","16262092006")
---------------------------------------------------------------------------
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
