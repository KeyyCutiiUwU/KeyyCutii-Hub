...
Closed.Image = "rbxassetid://16251448943"
...
game:GetService("Players").LocalPlayer.Idled:connect(function()
    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            PageImage.Image = "rbxassetid://16251448943"..tostring(Image)
            ...
            function main:AddDropdown(text,table,callback)
                ...
                DropImage.Image = "rbxassetid://16251448943"
...
local Main = SOMEXHUB:AddTab("Mục Chính","16251448943")
local Sea = SOMEXHUB:AddTab("Mục Event Biển","16251448943")
local M = SOMEXHUB:AddTab("Mục Vật Phẩm","16251448943")
local Ss = SOMEXHUB:AddTab("Mục Chỉ Số","16251448943")
local RaceV4 = SOMEXHUB:AddTab("Mục V4","16251448943")
local P = SOMEXHUB:AddTab("Mục Người chơi","16251448943")
local R = SOMEXHUB:AddTab("Mục Đột Kích","16251448943")
local T = SOMEXHUB:AddTab("Mục Dịch Chuyển","16251448943")
local S = SOMEXHUB:AddTab("Mục Cửa Hàng","16251448943")
