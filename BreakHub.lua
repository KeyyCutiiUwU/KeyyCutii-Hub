...
local LogoUI = _G.Settings.Logo or "16329793039"
...
Shop2:Button("Random Race (Use 3K Fragments)", function()
    ...
    Misc:Button("Destroy Ui",function()
        if game.CoreGui:FindFirstChild("BREAK HUB") then
            game.CoreGui:FindFirstChild("BREAK HUB"):Destroy()
