...
local Sea = SOMEXHUB:AddTab("Mục Event Biển","16241461895")
local M = SOMEXHUB:AddTab("Mục Vật Phẩm","16241461895")
local Ss = SOMEXHUB:AddTab("Mục Chỉ Số","16241461895")
local RaceV4 = SOMEXHUB:AddTab("Mục V4","16241461895")
local P = SOMEXHUB:AddTab("Mục Người chơi","16241461895")
local R = SOMEXHUB:AddTab("Mục Đột Kích","16241461895")
local T = SOMEXHUB:AddTab("Mục Dịch Chuyển","16241461895")
local S = SOMEXHUB:AddTab("Mục Cửa Hàng","16241461895")
local D = SOMEXHUB:AddTab("Mục Trái","16241461895")
