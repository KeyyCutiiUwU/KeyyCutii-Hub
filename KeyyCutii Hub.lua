...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Chào, Chúc bạn ngày mới tốt lành<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Phiên dịch : Tkhang<Color=/>"):Display()
    wait(.14)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Channel : TKHANGG <Color=/>"):Display()
    wait(.36)
end)
...
OrionLib:MakeNotification({
	Name = "KeyyCutii Hub",
	Content = "Chọn đội đi bro?",
	Image = "rbxassetid://16136469067",
	Time = 7
})

OrionLib:MakeNotification({
    Name = "KeyyCutii Hub",
    Content = "Vui lòng chờ tải tập lệnh...Không bật bất kỳ chức năng nào",
    Image = "rbxassetid://16136469067",
    Time = 5
})
