...
local LogoUI = _G.Settings.Logo or "16149544280"
...
ImageLabel.Image = "rbxassetid://14994300823"
...
Shop2:Button("Random Race (Use 3K Fragments)", function()
    ...
    Misc:Button("Destroy Ui",function()
        if game.CoreGui:FindFirstChild("SHADOW HUB") then
            game.CoreGui:FindFirstChild("SHADOW HUB"):Destroy()
